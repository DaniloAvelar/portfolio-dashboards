...
MétricaDescriçãoLucroDiferença entre o valor de venda e os custosMargemLucroPercentual de lucro sobre o valor de venda
...
VisualDescrição🔽 Painel de FiltrosFiltro por Ano/Mês e por Categoria de Produto📉 Gráfico de LinhaComportamento da Margem de Lucro ao longo do tempo (2011–2014)📊 Gráfico de CascataSoma de Valor de Venda por Modo de Envio🔘 Medidor (Gauge)Média de Valor de Venda com meta definida (500)🟦 Mapa de Árvore (Treemap)Média de Custo de Envio segmentada por Mercado🍩 Gráfico de RoscaMédia de Lucro distribuída por Categoria de Produto
...
LinkedIn: Danilo Aliotto Avelar
